<section class="w-full">
    <div class="relative mb-6 w-full">
        ...
        <flux:subheading size="lg" class="mb-6">A list of all the {{ __('Categorias') }}</flux:subheading>
                ...
                <div class="w-full">
                    <div class="sm:flex sm:items-center">
                        ...
                        <div class="mt-4 sm:ml-16 sm:mt-0 sm:flex-none">
                            <flux:button variant="primary"  :href="route('categorias.create')">{{ __('Add New') }}</flux:butt>
                        </div>
                    </div>
